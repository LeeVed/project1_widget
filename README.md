...
10. def log(filename) декоратор для логирования с настройками
11. def convert_currency(currency, amount)
Функция, которая принимает на вход транзакцию и возвращает сумму транзакции в рублях
12. def open_json(path)
Функция по заданному пути открывает json файл и возвращает его
13. convert_amount(item)
Функция возвращает сумму транзакции в рублях
14. Добавлено логирование для файлов utils и masks
15. read_transaction_csv(file_path)
функция считывает финансовые операции из CSV и возвращает список словарей с транзакциями
16. read_transaction_excel(file_path)
функция считывает финансовые операции из Excel и выдает список словарей с транзакциями
17. process_bank_search
Функция возвращает список словарей, у которых в описании есть строка поиска.
...
в каждой категории.
19. main
Функция отвечает за логику работы всей программы.
...
├── test_decorators.py # Тесты к декоратору (5 тестов)
├── test_external_api # Тесты к API (1 тест)
├── test_utils # Тесты к функции для открытия файла и конвертации в рубли (3 теста)
├── test_csv_excel_reader # Тесты к функциям, считывающим разные форматы(2 теста)
└── test_bank_operations # Тесты обработки банковских операций (6 тестов)
